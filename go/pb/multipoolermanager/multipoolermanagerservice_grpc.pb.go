...
const (
	...
	MultipoolerManager_SetParameters_FullMethodName              = "/multipoolermanager.MultipoolerManager/SetParameters"
...
type MultipoolerManagerClient interface {
	...
	// controlled failover.
	SetParameters(ctx context.Context, in *multipoolermanagerdata.SetParametersRequest, opts ...grpc.CallOption) (*multipoolermanagerdata.SetParametersResponse, error)
...
func (c *multipoolerManagerClient) SetParameters(ctx context.Context, in *multipoolermanagerdata.SetParametersRequest, opts ...grpc.CallOption) (*multipoolermanagerdata.SetParametersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(multipoolermanagerdata.SetParametersResponse)
	err := c.cc.Invoke(ctx, MultipoolerManager_SetParameters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MultipoolerManagerServer interface {
	...
	// keep a high promotion timeout during bootstrap and lower it before a
	// controlled failover.
	SetParameters(context.Context, *multipoolermanagerdata.SetParametersRequest) (*multipoolermanagerdata.SetParametersResponse, error)
	// ManagerHealthStream is a bidirectional health stream between orchestrator
	// and pooler.
	//
	// The orchestrator sends a start message (ManagerHealthStreamClientMessage
...
func (UnimplementedMultipoolerManagerServer) SetParameters(context.Context, *multipoolermanagerdata.SetParametersRequest) (*multipoolermanagerdata.SetParametersResponse, error) {
...
func _MultipoolerManager_SetParameters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(multipoolermanagerdata.SetParametersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MultipoolerManagerServer).SetParameters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MultipoolerManager_SetParameters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultipoolerManagerServer).SetParameters(ctx, req.(*multipoolermanagerdata.SetParametersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MultipoolerManager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MultipoolerManager_SetParameters_Handler,
		},
	},
