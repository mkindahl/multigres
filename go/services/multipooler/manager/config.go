...
type Config struct {
	...
	// FinalSnapshotTimeout must fit inside the announced shutdown_deadline. Drain
	// is handled by --connpool-drain-grace-period before the announce, so it is
	// not part of the announced budget.
